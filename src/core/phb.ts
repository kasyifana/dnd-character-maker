  ...
  public classes: Class[] = [
    {
      ...
      features: [
  { id: 0, level: 1, text: 'Rage (p.48)', descriptionRef: 'barbarian > rage' },
  { id: 1, level: 1, text: 'Unarmored Defense (p.48)', descriptionRef: 'barbarian > unarmored-defense' },
  { id: 2, level: 2, text: 'Reckless Attack (p.48)', descriptionRef: 'barbarian > reckless-attack' },
  { id: 3, level: 2, text: 'Danger Sense (p.48)', descriptionRef: 'barbarian > danger-sense' },
  { id: 4, level: 5, text: 'Extra Attack (p.49)', descriptionRef: 'barbarian > extra-attack' },
  { id: 5, level: 5, text: 'Fast Movement (p.49)', descriptionRef: 'barbarian > fast-movement' },
  { id: 6, level: 7, text: 'Feral Instinct (p.49)', descriptionRef: 'barbarian > feral-instinct' },
  { id: 7, level: 9, text: 'Brutal Critical (p.49)', descriptionRef: 'barbarian > brutal-critical' },
  { id: 8, level: 11, text: 'Relentless Rage (p.49)', descriptionRef: 'barbarian > relentless-rage' },
  { id: 9, level: 15, text: 'Persistent Rage (p.49)', descriptionRef: 'barbarian > persistent-rage' },
  { id: 10, level: 18, text: 'Indomitable Might (p.49)', descriptionRef: 'barbarian > indomitable-might' },
  { id: 11, level: 20, text: 'Primal Champion (p.49)', descriptionRef: 'barbarian > primal-champion' },
        // Path of the Berserker
  { id: 12, level: 3, archetypeId: 0, text: 'Frenzy (p.49)', descriptionRef: 'barbarian > path-of-the-berserker > frenzy' },
  { id: 13, level: 6, archetypeId: 0, text: 'Mindless Rage (p.49)', descriptionRef: 'barbarian > path-of-the-berserker > mindless-rage' },
  { id: 14, level: 10, archetypeId: 0, text: 'Intimidating Presence (p.49)', descriptionRef: 'barbarian > path-of-the-berserker > intimidating-presence' },
  { id: 15, level: 14, archetypeId: 0, text: 'Retaliation (p.50)', descriptionRef: 'barbarian > path-of-the-berserker > retaliation' },
    ...
    },
    {
      ...
      features: [
  { id: 0, level: 1, text: 'Bardic Inspiration (p.53)', descriptionRef: 'bard > bardic-inspiration' },
  { id: 1, level: 2, text: 'Jack of all trades (p.54)', descriptionRef: 'bard > jack-of-all-trades' },
  { id: 2, level: 2, text: 'Song of rest (p.54)', descriptionRef: 'bard > song-of-rest' },
  { id: 3, level: 3, text: 'Expertise (p.54)', descriptionRef: 'bard > expertise' },
  { id: 4, level: 5, text: 'Font of Inspiration (p.54)', descriptionRef: 'bard > font-of-inspiration' },
  { id: 5, level: 6, text: 'Countercharm (p.54)', descriptionRef: 'bard > countercharm' },
  { id: 6, level: 10, text: 'Magical Secrets (p.54)', descriptionRef: 'bard > magical-secrets' },
  { id: 7, level: 20, text: 'Superior Inspiration (p.54)', descriptionRef: 'bard > superior-inspiration' },
        // College of Lore
  { id: 8, level: 3, archetypeId: 0, text: 'Cutting Words (p.54)', descriptionRef: 'bard > college-of-lore > cutting-words' },
  { id: 9, level: 7, archetypeId: 0, text: 'Additional Magical Secrets (p.55)', descriptionRef: 'bard > college-of-lore > additional-magical-secrets' },
  { id: 10, level: 14, archetypeId: 0, text: 'Peerless Skill (p.55)', descriptionRef: 'bard > college-of-lore > peerless-skill' },
        // College of Valor
    ...
    },
    {
      ...
      features: [
  { id: 0, level: 2, text: 'Channel Divinity [  ] (p.58)', descriptionRef: 'cleric > channel-divinity' },
  { id: 1, level: 6, text: 'Channel Divinity [  ][  ] (p.58)', replaces: 0, descriptionRef: 'cleric > channel-divinity' },
  { id: 2, level: 18, text: 'Channel Divinity [  ][  ][  ] (p.58)', replaces: 1, descriptionRef: 'cleric > channel-divinity' },
  { id: 3, level: 2, text: 'CD: Turn Undead (p.59)', descriptionRef: 'cleric > channel-divinity-turn-undead' },
  { id: 4, level: 5, text: 'Destroy Undead (p.59)', descriptionRef: 'cleric > destroy-undead' },
  { id: 5, level: 10, text: 'Divine Intervention [  ] (p.59)', descriptionRef: 'cleric > divine-intervention' },
        // Knowledge
        ...
        // Life
  { id: 11, level: 1, archetypeId: 1, text: 'Bonus Proficiency: Heavy Armor (p.60)', descriptionRef: 'cleric > life-domain > bonus-proficiency' },
  { id: 12, level: 1, archetypeId: 1, text: 'Disciple of Life (p.60)', descriptionRef: 'cleric > life-domain > disciple-of-life' },
  { id: 13, level: 2, archetypeId: 1, text: 'CD: Preserve Life (p.60)', descriptionRef: 'cleric > life-domain > channel-divinity-preserve-life' },
  { id: 14, level: 6, archetypeId: 1, text: 'Blessed Healer (p.60)', descriptionRef: 'cleric > life-domain > blessed-healer' },
  { id: 15, level: 8, archetypeId: 1, text: 'Divine Strike (p.60)', descriptionRef: 'cleric > life-domain > divine-strike' },
  { id: 16, level: 17, archetypeId: 1, text: 'Supreme Healing (p.60)', descriptionRef: 'cleric > life-domain > supreme-healing' },
        // Light
    ...
    },
    {
      ...
      features: [
  { id: 0, level: 1, text: 'Divine Sense (p.84)', descriptionRef: 'paladin > divine-sense' },
  { id: 1, level: 1, text: 'Lay on Hands (p.84)', descriptionRef: 'paladin > lay-on-hands' },
  { id: 2, level: 2, text: 'Fighting Style (p.84)', descriptionRef: 'paladin > fighting-style' },
  { id: 3, level: 2, text: 'Divine Smite (p.85)', descriptionRef: 'paladin > divine-smite' },
  { id: 4, level: 3, text: 'Divine Health (p.85)', descriptionRef: 'paladin > divine-health' },
  { id: 5, level: 5, text: 'Extra Attack (p.85)', descriptionRef: 'paladin > extra-attack' },
  { id: 6, level: 6, text: 'Aura of Protection (p.85)', descriptionRef: 'paladin > aura-of-protection' },
  { id: 7, level: 18, text: 'Aura of Protection (p.85)', replaces: 6, descriptionRef: 'paladin > aura-of-protection' },
  { id: 8, level: 10, text: 'Aura of Courage (p.85)', descriptionRef: 'paladin > aura-of-courage' },
  { id: 9, level: 18, text: 'Aura of Courage (p.85)', replaces: 8, descriptionRef: 'paladin > aura-of-courage' },
  { id: 10, level: 11, text: 'Improved Divine Smite (p.85)', replaces: 3, descriptionRef: 'paladin > improved-divine-smite' },
  { id: 11, level: 14, text: 'Cleansing Touch (p.85)', descriptionRef: 'paladin > cleansing-touch' },
  { id: 12, level: 3, text: 'Channel Divinity [  ] (p.85)', descriptionRef: 'paladin > channel-divinity' },
        // Oath of Devotion
  { id: 13, level: 3, archetypeId: 0, text: 'CD: Sacred Weapon (p.86)', descriptionRef: 'paladin > oath-of-devotion > channel-divinity-sacred-weapon' },
  { id: 14, level: 3, archetypeId: 0, text: 'CD: Turn the Unholy (p.86)', descriptionRef: 'paladin > oath-of-devotion > channel-divinity-turn-the-unholy' },
  { id: 15, level: 7, archetypeId: 0, text: 'Aura of Devotion (p.86)', descriptionRef: 'paladin > oath-of-devotion > aura-of-devotion' },
  { id: 16, level: 18, archetypeId: 0, text: 'Aura of Devotion (p.86)', replaces: 15, descriptionRef: 'paladin > oath-of-devotion > aura-of-devotion' },
  { id: 17, level: 15, archetypeId: 0, text: 'Purity of Spirit (p.86)', descriptionRef: 'paladin > oath-of-devotion > purity-of-spirit' },
  { id: 18, level: 20, archetypeId: 0, text: 'Holy Nimbus (p.86)', descriptionRef: 'paladin > oath-of-devotion > holy-nimbus' },
